          ...
          <div class='card' id='aboutme-card'>
            <div class='content'>
              ...
              <div id='profile-pic-contact-info'>           
                <div id='profile-pic'>
                  <img src={ProfilePic} alt='dam-pic' width='300px' height='375px' />
                </div>

                <div>
                  <div id='contact-me-card' class='card'>
                    <div class='content'>
                      <p id='contact-info-header' class='contact-info'>Contact Me</p>
                      <p class='contact-info'><span class='icon'><i class="fas fa-mobile-alt"></i></span> 832.788.6318</p>
